  ...
  sprintf(command, "set parametric;\
		    ...
		    fb = %f; \
                    ...
                    plot fa,t, \
                         fb,t, \
                         fa_epsilon,t, \
		         'seq_a.dat' using 1:2 with lines lw 2 title 'f(x) = 3 + 1 / x ', \
			 'seq_a.dat' using 1:4 with dots lw 2 title 'convergencia + epsilon', \
                         'seq_a.dat' using 1:3 with lines lw 2 title 'convergencia'", trange_a, trange_b, xrange_a, xrange_b, yrange_a, yrange_b, fa, fb, fa_epsilon);
  /*printf(command);*/
